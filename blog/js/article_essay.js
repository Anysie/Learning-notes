...
// 获取对象
const essayList = document.querySelector('.article .essay-list')
let htmlStr = ''
//放入数据
for(let i = 0 ; i < articleData.length ; i++){
  htmlStr += 
  `
    <a href="${articleData[i].essay}">
      <div class="essay">
        <h4>${articleData[i].title}</h4>
        <p>${articleData[i].para}</p>
      </div>
    </a>
  `
}
essayList.innerHTML = htmlStr
...
// <div class="article">
//   <h3><i class="iconfont icon-boke"></i>主要文章</h3>
//   <a href="">
//   <div class="essay">
//     <h4></h4>
//     <p></p>
